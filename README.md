...
* Wizard
  * Abjuration school
    * The ward triggers on all spells
  * Divination school
    * The wizard regains the portent dice on short rest
...
* 5e spells
  ...
  * Rebalance
  * Non-lethal overhaul
    * Shocking grasp does non-lethal damage by default
    * Sleep affects up to 48 hitpoints
    * Phantasmal force does non-lethal damage by default
    * Ray of engeeblement: the target looses conciousness while under 10 hp
    * Bestow curse:  the target looses conciousness while under 10 hp
  * Disarming overhaul
    * Summons and constructs can disarm.
      * Examples:
      * Mage hand
      * Animated dead
      * Conjured elemental
      * Unseen servant
      * Phantasmal killer
    * Hypnotic pattern: hypnotized creatures drop their weapons
    * Stinking cloud: affected creatures drop their weapons
    * Benign transposition: can disarm
    * Arcane gate: can disarm
    * Teleport: can disarm
    * Banishment: can disarm
  * Sealing overhaul
    * Hold person: hold person becomes a permanent curse if it lasts for 10 turns.
    * Banishment: if casted over a one minute period the effect becomes a curse and becomes permanent.
    * Planar binding: if casted over a one minute period the effect becomes a curse and becomes permanent.
    * Stoneskin: sacrifice stoneskin effect: the targets skin turns to stone and gets the hold person effect.
  * Crowdcontroll
    * Walls
  ...
  * Anti-radar
    ...
    * Gate seal (SATO) is a 2nd level spell.
